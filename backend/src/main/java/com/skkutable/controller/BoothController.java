...
class BoothController {
  ...
  public Booth registerBooth(@PathVariable Long festivalId, @RequestParam String name,
  ...
  public Booth updateBoothImages(@PathVariable Long festivalId, @PathVariable Long boothId,
    ...
    if (posterImage != null) {
      imageMap.put("posterImage", posterImage);
    }
    if (eventImage != null) {
      imageMap.put("eventImage", eventImage);
    }
  ...
  public Booth patchBooth(@PathVariable Long festivalId, @PathVariable Long boothId,
      @RequestBody @Valid BoothPatchDto dto) {
