...
public class UserLikeController {
  ...
  public ResponseEntity<Map<String, Object>> toggleFestivalLike(@PathVariable Long userId,
  ...
  public ResponseEntity<Map<String, Object>> toggleBoothLike(@PathVariable Long userId,
